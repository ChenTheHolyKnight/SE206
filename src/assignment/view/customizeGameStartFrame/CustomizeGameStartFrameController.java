package assignment.view.customizeGameStartFrame;
...
public class CustomizeGameStartFrameController extends Controller{
	...
	private void setEquation(Level level) {
		...
		String formula=formulas.get(_frameCounter.getCounter());
